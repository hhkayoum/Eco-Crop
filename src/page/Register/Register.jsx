            ...
            <div className="bg-white p-8 shadow-md w-96 rounded-md">
              ...
              <form onSubmit={handleCreateUser}>
                ...
                <div>
                  <button
                    type="submit"
                    className="bg-[#F4853A] text-white p-2 rounded w-full hover:bg-[#f06770]  focus:outline-none focus:ring focus:border-blue-300"
                  >
                    Register
                  </button>
                </div>
              ...
              <div>
                <p>
                  ...
                  <Link to={"/login"}>
                    <span className="text-[#F4853A] font-medium">Login</span>
                  </Link>
                </p>
              </div>
            </div>
