          ...
          <div className="bg-white p-8  shadow-md w-96 rounded-md">
            ...
            <form className="" onSubmit={handleEmailLogin}>
              ...
              <div>
                <button
                  type="submit"
                  className="bg-[#F4853A] text-white p-2 rounded w-full hover:bg-[#f56b74]  focus:outline-none focus:ring focus:border-blue-300"
                >
                  Log In
                </button>
              </div>
            ...
            <div>
              <p>
                ...
                <Link to={"/register"}>
                  {" "}
                  <span className="text-[#F4853A] font-medium">
                    REGISTER
                  </span>{" "}
                </Link>
              </p>
